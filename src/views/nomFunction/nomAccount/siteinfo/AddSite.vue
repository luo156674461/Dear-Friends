<template>
    <div class="addsite">
        <div class="head">
            ...
            <span class="add_s" @click="save">保存</span>
        </div>
        <div class="content">
            <div class="s_in">
                <Form ref="siteInline" :model="siteInline" :rules="ruleInline" inline>
                    <div class="s_man">
                        <span class="icon"></span>
                        <FormItem prop="user">
                            <Input name="user" type="text" v-model="siteInline.user" placeholder="收货人" style="width: 100%" />
                        </FormItem>
                    </div>
                    <div class="s_cell">
                        <span class="icon"></span>
                        <FormItem prop="cell">
                            <Input name="cell" type="text" v-model="siteInline.cell" placeholder="手机号码" style="width: 100%" />
                        </FormItem>
                    </div>
                    <div class="s_site">
                        <span class="icon"></span>
                        <FormItem prop="site">
                            <Input name="site" type="text" v-model="siteInline.site" placeholder="所在地区" style="width: 100%" />
                        </FormItem>
                        <Icon type="ios-arrow-down" @click="choseAdd" />
                    </div>
                </Form>
            </div>
            <div class="s_detailed">
                <Input v-model="siteInline.d_site" type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="详细地址：如道路、门牌号、小区、楼栋号、单元室等" />
            </div>
            <div class="default">
                <span class="txt">设为默认地址</span>
                <van-switch v-model="checked" active-color="#07c160" inactive-color="#f44" size="24px" />
            </div>
            <!--居住地址三级联动选项-->
            <section class="showChose" v-show="showChose">
                <section class="address">
                    <section class="title">
                        <h4>居住地址</h4>
                        <Icon type="ios-close" @click="closeAdd()" />
                    </section>
                    <section class="title">
...
export default {
    ...
    methods: {
        ...
        getDistrictId: function(code, input, index) {
            ...
            this.siteInline.site = `${this.Province} ${this.City} ${this.District}`
            // 选取市区选项之后关闭弹层
            this.showChose = false;
        },
