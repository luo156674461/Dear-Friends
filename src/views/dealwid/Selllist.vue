            ...
            <div class="seek"> 
                ...
                <div class="purchase" v-for="(i, index) in limit" :key="index">
                    ...
                    <div class="bus-tail">
                        ...
                        <Button type="primary" @click="goPlace(i)">求购中</Button>
                    </div>
                </div>
                <a href=""></a>
            </div>
...
export default {
    ...
    mounted() {
        this.$nextTick(() => {
            this.sellScroll = new BScroll(this.$refs.sell, {
                click: true
            })
        })
    },
    ...
    methods: {
        ...
        _into() {
            ...
            this.$api.get(`get_market_limit/B/?token=${token}&user=${this.mess.user}`, {}, r => {
            ...
            this.loadopen()
                ...
                if (this.mess.user !== val.user) {
                    if (this.userInfo.payment_method.method_bankcard === '0') {
                        ...
                        var token = this.$des.encrypt(`${this.mess.token}${this.arrNum}`)
