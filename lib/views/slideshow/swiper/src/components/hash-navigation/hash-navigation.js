...
var HashNavigation = {
  ...
  init: function init() {
    ...
    if (swiper.params.hashNavigation.watchState) {
      (0, _dom2.default)(_ssrWindow.window).on('hashchange', swiper.hashNavigation.onHashCange);
    }
  },
  destroy: function destroy() {
    var swiper = this;
    if (swiper.params.hashNavigation.watchState) {
      (0, _dom2.default)(_ssrWindow.window).off('hashchange', swiper.hashNavigation.onHashCange);
    }
  }
};
exports.default = {
