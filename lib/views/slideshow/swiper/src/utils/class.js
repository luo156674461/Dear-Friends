...
var SwiperClass = function () {
  function SwiperClass() {
    ...
    (0, _classCallCheck3.default)(this, SwiperClass);
  ...
  (0, _createClass3.default)(SwiperClass, [{
    key: 'on',
    ...
    value: function installModule(module) {
      ...
      var name = module.name || (0, _keys2.default)(Class.prototype.modules).length + '_' + _utils2.default.now();
